...
@Component({
  selector: 'ngx-chart-reaction-song',
  templateUrl: './chart-reaction-song.component.html',
  styleUrls: ['./chart-reaction-song.component.scss']
})
export class ChartReactionSongComponent implements OnInit {
  isLoading = true;
  echartsIntance: any;
  options = {
  ...
  {
    this.isLoading = true;
    this.dbService.getAll(time).then(res=>{
