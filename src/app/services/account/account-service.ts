...
export class AccountHttpClient extends ServiceBaseHttpClient {
    ...
    getAllAccount(keyword: string | undefined,roleBase: string | undefined, sortParameter: SortParameter): Promise<any> {
        let url_ = this.basePrefix + "/GetAllAccount?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        if (roleBase === null)
            throw new Error("The parameter 'roleBase' cannot be null.");
        else if (roleBase !== undefined)
            url_ += "RoleBase=" + encodeURIComponent("" + roleBase) + "&";
    ...
    getListAccountDeleted(keyword: string | undefined, sortParameter: SortParameter): Promise<any> {
